...
const messagesByContext = {
  ...
  dailyGreeting: [
    ...
    "やる気ゼロでも、1分で変われる。さあ、\"提出への一歩\"を踏み出そう。",
    "知ってた？提出ボタンを押すと、脳内に\"ドーパミン花火\"が打ち上がるんだって！",
  ],
  ...
  urgentDeadline: [
    ...
    "まだ間に合う。焦り始めた今が、ゴールへの最高のスタートだよ。",
    "提出締切まで…残り2時間。え、余裕？ぼくならもう震えてるけど…！",
  ],
  ...
  rankingFirst: [
    ...
    "今週のランキング、あと1課題でトップ10入り。やっちゃう？",
    "1ページ書くたびに、君の称号が進化していく。今の君は\"未提出の勇者\"！",
  ],
  ...
  default: [
    ...
    "友達とランキングを競い合おう！🎯",
    "継続は力なり！今日も頑張って！💪",
    "君が課題をやらないと…ぼくが泣くけど…それでもいいの…？（涙目）",
    "やればいいってもんじゃない。…やれば\"いい\"んだよ。",
    "今日はまだ1ミッションも終わってないよ？…あれ、スマホ触る時間はあるのに？",
  ]
}
